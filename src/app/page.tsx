...
export default function Home() {
  ...
  return <main>
    <nav><a className="brand" href="#top"><span>SR</span> StudyRoute</a><a className="nav-link" href="#how">How it works</a></nav>
    ...
    <section className="planner" id="planner">
      <aside className="setup">
        ...
        <label>What do you want to work on?</label><div className="chip-row">{topics.map((topic) => <button key={topic} className={input.topic === topic ? "chip active" : "chip"} onClick={() => update("topic", topic)}>{topic}</button>)}</div>
        ...
        <label>Format you enjoy</label><div className="format-list">{formats.map((format) => <button key={format} className={input.preferredFormat === format ? "format active" : "format"} onClick={() => update("preferredFormat", format)}>{format}</button>)}</div>
      </aside>
